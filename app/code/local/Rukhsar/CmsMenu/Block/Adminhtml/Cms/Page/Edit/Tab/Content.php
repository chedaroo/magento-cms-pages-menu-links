...
class Rukhsar_CmsMenu_Block_Adminhtml_Cms_Page_Edit_Tab_Content extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function prepareForm($observer)
    {
        ...
        if($isEnabled) {
            ...
            $fathersList = Mage::helper('rukhsar_cmsmenu')->getFathersList();
